<?php
/**
 * File for class MagentoStructLanguage
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructLanguage originally named language
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructLanguage extends MagentoWsdlClass
{
	/**
	 * The _
	 * @var MagentoStructLanguage
	 */
	public $_;
	/**
	 * The id
	 ...
	 * @param MagentoStructLanguage $__
	 * @param MagentoStructID $_id
	 * @param MagentoStructAnyURI $_href
	 * @return MagentoStructLanguage
	 */
	...
	/**
	 * Get _ value
	 * @return MagentoStructLanguage|null
	 */
	...
	/**
	 * Set _ value
	 * @param MagentoStructLanguage $__ the _
	 * @return MagentoStructLanguage
	 */

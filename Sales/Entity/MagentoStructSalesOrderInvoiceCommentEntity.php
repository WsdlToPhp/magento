<?php
/**
 * File for class MagentoStructSalesOrderInvoiceCommentEntity
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructSalesOrderInvoiceCommentEntity originally named salesOrderInvoiceCommentEntity
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructSalesOrderInvoiceCommentEntity extends MagentoWsdlClass
{
	/**
	 * The increment_id
	...
	public $comment_id;
	/**
	 * Constructor method for salesOrderInvoiceCommentEntity
	 ...
	 * @return MagentoStructSalesOrderInvoiceCommentEntity
	 */

<?php
/**
 * File for class MagentoStructAnyURI
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructAnyURI originally named anyURI
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructAnyURI extends MagentoWsdlClass
{
	/**
	 * The _
	...
	public $href;
	/**
	 * Constructor method for anyURI
	 * @see parent::__construct()
	 * @param MagentoStructAnyURI $__
	...
	/**
	 * Set _ value
	 * @param MagentoStructAnyURI $__ the _
	 * @return MagentoStructAnyURI
	 */

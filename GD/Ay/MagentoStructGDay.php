<?php
/**
 * File for class MagentoStructGDay
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructGDay originally named gDay
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructGDay extends MagentoWsdlClass
{
	/**
	 * The _
	 * @var MagentoStructGDay
	 */
	public $_;
	/**
	 * The id
	...
	public $href;
	/**
	 * Constructor method for gDay
	 * @see parent::__construct()
	 * @param MagentoStructGDay $__
	 * @param MagentoStructID $_id
	 * @param MagentoStructAnyURI $_href
	 * @return MagentoStructGDay
	 */
	...
	/**
	 * Set _ value
	 * @param MagentoStructGDay $__ the _
	 * @return MagentoStructGDay
	 */

<?php
/**
 * File for class MagentoStructCatalogCategoryEntityNoChildren
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructCatalogCategoryEntityNoChildren originally named catalogCategoryEntityNoChildren
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructCatalogCategoryEntityNoChildren extends MagentoWsdlClass
{
	/**
	 * The category_id
	...
	public $level;
	/**
	 * Constructor method for catalogCategoryEntityNoChildren
	 ...
	 * @return MagentoStructCatalogCategoryEntityNoChildren
	 */
	public function __construct($_category_id = NULL,$_parent_id = NULL,$_name = NULL,$_is_active = NULL,$_position = NULL,$_level = NULL)
	{
		parent::__construct(array('category_id'=>$_category_id,'parent_id'=>$_parent_id,'name'=>$_name,'is_active'=>$_is_active,'position'=>$_position,'level'=>$_level));
	}
	/**

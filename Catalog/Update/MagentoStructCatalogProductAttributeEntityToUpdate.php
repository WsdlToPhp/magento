<?php
/**
 * File for class MagentoStructCatalogProductAttributeEntityToUpdate
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructCatalogProductAttributeEntityToUpdate originally named catalogProductAttributeEntityToUpdate
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructCatalogProductAttributeEntityToUpdate extends MagentoWsdlClass
{
	/**
	 * The scope
	...
	/**
	 * Constructor method for catalogProductAttributeEntityToUpdate
	 ...
	 * @return MagentoStructCatalogProductAttributeEntityToUpdate
	 */
	public function __construct($_scope = NULL,$_default_value = NULL,$_is_unique = NULL,$_is_required = NULL,$_apply_to = NULL,$_is_configurable = NULL,$_is_searchable = NULL,$_is_visible_in_advanced_search = NULL,$_is_comparable = NULL,$_is_used_for_promo_rules = NULL,$_is_visible_on_front = NULL,$_used_in_product_listing = NULL,$_additional_fields = NULL,$_frontend_label = NULL)
	{
		parent::__construct(array('scope'=>$_scope,'default_value'=>$_default_value,'is_unique'=>$_is_unique,'is_required'=>$_is_required,'apply_to'=>$_apply_to,'is_configurable'=>$_is_configurable,'is_searchable'=>$_is_searchable,'is_visible_in_advanced_search'=>$_is_visible_in_advanced_search,'is_comparable'=>$_is_comparable,'is_used_for_promo_rules'=>$_is_used_for_promo_rules,'is_visible_on_front'=>$_is_visible_on_front,'used_in_product_listing'=>$_used_in_product_listing,'additional_fields'=>$_additional_fields,'frontend_label'=>$_frontend_label));
	}
	/**
	 * Get scope value

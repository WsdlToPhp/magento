<?php
/**
 * File for class MagentoStructCatalogProductCustomOptionToUpdate
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructCatalogProductCustomOptionToUpdate originally named catalogProductCustomOptionToUpdate
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructCatalogProductCustomOptionToUpdate extends MagentoWsdlClass
{
	/**
	 * The title
	...
	/**
	 * Constructor method for catalogProductCustomOptionToUpdate
	 ...
	 * @return MagentoStructCatalogProductCustomOptionToUpdate
	 */

<?php
/**
 * File for class MagentoStructCatalogProductReturnEntity
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructCatalogProductReturnEntity originally named catalogProductReturnEntity
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructCatalogProductReturnEntity extends MagentoWsdlClass
{
	/**
	 * The product_id
	...
	/**
	 * The enable_googlecheckout
	 * @var MagentoStructString
	 */
	public $enable_googlecheckout;
	/**
	 * Constructor method for catalogProductReturnEntity
	 ...
	 * @param MagentoStructString $_type_id
	 ...
	 * @param associativeArray $_additional_attributes
	 * @param MagentoStructString $_enable_googlecheckout
	 * @return MagentoStructCatalogProductReturnEntity
	 */
	public function __construct($_product_id = NULL,$_sku = NULL,$_set = NULL,$_type = NULL,$_categories = NULL,$_websites = NULL,$_created_at = NULL,$_updated_at = NULL,$_type_id = NULL,$_name = NULL,$_description = NULL,$_short_description = NULL,$_weight = NULL,$_status = NULL,$_url_key = NULL,$_url_path = NULL,$_visibility = NULL,$_category_ids = NULL,$_website_ids = NULL,$_has_options = NULL,$_gift_message_available = NULL,$_price = NULL,$_special_price = NULL,$_special_from_date = NULL,$_special_to_date = NULL,$_tax_class_id = NULL,$_tier_price = NULL,$_meta_title = NULL,$_meta_keyword = NULL,$_meta_description = NULL,$_custom_design = NULL,$_custom_layout_update = NULL,$_options_container = NULL,$_additional_attributes = NULL,$_enable_googlecheckout = NULL)
	{
		parent::__construct(array('product_id'=>$_product_id,'sku'=>$_sku,'set'=>$_set,'type'=>$_type,'categories'=>$_categories,'websites'=>$_websites,'created_at'=>$_created_at,'updated_at'=>$_updated_at,'type_id'=>$_type_id,'name'=>$_name,'description'=>$_description,'short_description'=>$_short_description,'weight'=>$_weight,'status'=>$_status,'url_key'=>$_url_key,'url_path'=>$_url_path,'visibility'=>$_visibility,'category_ids'=>$_category_ids,'website_ids'=>$_website_ids,'has_options'=>$_has_options,'gift_message_available'=>$_gift_message_available,'price'=>$_price,'special_price'=>$_special_price,'special_from_date'=>$_special_from_date,'special_to_date'=>$_special_to_date,'tax_class_id'=>$_tax_class_id,'tier_price'=>$_tier_price,'meta_title'=>$_meta_title,'meta_keyword'=>$_meta_keyword,'meta_description'=>$_meta_description,'custom_design'=>$_custom_design,'custom_layout_update'=>$_custom_layout_update,'options_container'=>$_options_container,'additional_attributes'=>$_additional_attributes,'enable_googlecheckout'=>$_enable_googlecheckout));
	}
	/**
	...
	/**
	 * Set type_id value
	 * @param MagentoStructString $_type_id the type_id
	 * @return MagentoStructString
	 */
	public function setType_id($_type_id)
	{
		return ($this->type_id = $_type_id);
	}
	/**
	 * Get name value
	 * @return MagentoStructString|null
	 ...
	 * @param associativeArray $_additional_attributes the additional_attributes
	...
	/**
	 * Get enable_googlecheckout value
	 * @return MagentoStructString|null
	 */
	...
	/**
	 * Set enable_googlecheckout value
	 * @param MagentoStructString $_enable_googlecheckout the enable_googlecheckout
	 * @return MagentoStructString
	 */
	public function setEnable_googlecheckout($_enable_googlecheckout)
	{
		return ($this->enable_googlecheckout = $_enable_googlecheckout);
	}
	/**

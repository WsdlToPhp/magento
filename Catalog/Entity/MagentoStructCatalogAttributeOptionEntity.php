<?php
/**
 * File for class MagentoStructCatalogAttributeOptionEntity
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructCatalogAttributeOptionEntity originally named catalogAttributeOptionEntity
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructCatalogAttributeOptionEntity extends MagentoWsdlClass
{
	/**
	 * The label
	 ...
	 * @return MagentoStructCatalogAttributeOptionEntity
	 */

<?php
/**
 * File for class MagentoStructCatalogProductCustomOptionInfoEntity
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructCatalogProductCustomOptionInfoEntity originally named catalogProductCustomOptionInfoEntity
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructCatalogProductCustomOptionInfoEntity extends MagentoWsdlClass
{
	/**
	 * The title
	...
	/**
	 * Constructor method for catalogProductCustomOptionInfoEntity

<?php
/**
 * File for class MagentoStructCatalogProductCustomOptionValueAddEntity
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructCatalogProductCustomOptionValueAddEntity originally named catalogProductCustomOptionValueAddEntity
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructCatalogProductCustomOptionValueAddEntity extends MagentoWsdlClass
{
	/**
	 * The title
	...
	public $sort_order;
	/**
	 * Constructor method for catalogProductCustomOptionValueAddEntity
	 ...
	 * @return MagentoStructCatalogProductCustomOptionValueAddEntity
	 */

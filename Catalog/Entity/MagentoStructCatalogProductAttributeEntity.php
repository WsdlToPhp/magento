<?php
/**
 * File for class MagentoStructCatalogProductAttributeEntity
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructCatalogProductAttributeEntity originally named catalogProductAttributeEntity
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructCatalogProductAttributeEntity extends MagentoWsdlClass
{
	/**
	 * The attribute_id
	...
	/**
	 * Constructor method for catalogProductAttributeEntity
	 * @see parent::__construct()
	 * @param MagentoStructString $_attribute_id
	 ...
	 * @param catalogAttributeOptionEntityArray $_options
	 * @param catalogProductAttributeFrontendLabelArray $_frontend_label
	 * @return MagentoStructCatalogProductAttributeEntity
	 */
	public function __construct($_attribute_id = NULL,$_attribute_code = NULL,$_frontend_input = NULL,$_scope = NULL,$_default_value = NULL,$_is_unique = NULL,$_is_required = NULL,$_apply_to = NULL,$_is_configurable = NULL,$_is_searchable = NULL,$_is_visible_in_advanced_search = NULL,$_is_comparable = NULL,$_is_used_for_promo_rules = NULL,$_is_visible_on_front = NULL,$_used_in_product_listing = NULL,$_additional_fields = NULL,$_options = NULL,$_frontend_label = NULL)
	{
		parent::__construct(array('attribute_id'=>$_attribute_id,'attribute_code'=>$_attribute_code,'frontend_input'=>$_frontend_input,'scope'=>$_scope,'default_value'=>$_default_value,'is_unique'=>$_is_unique,'is_required'=>$_is_required,'apply_to'=>$_apply_to,'is_configurable'=>$_is_configurable,'is_searchable'=>$_is_searchable,'is_visible_in_advanced_search'=>$_is_visible_in_advanced_search,'is_comparable'=>$_is_comparable,'is_used_for_promo_rules'=>$_is_used_for_promo_rules,'is_visible_on_front'=>$_is_visible_on_front,'used_in_product_listing'=>$_used_in_product_listing,'additional_fields'=>$_additional_fields,'options'=>$_options,'frontend_label'=>$_frontend_label));
	}
	/**
	 ...
	 * @param MagentoStructString $_attribute_id the attribute_id
	...
	/**
	 * Get options value
	 * @return catalogAttributeOptionEntityArray|null
	 */
	...
	/**
	 * Set options value
	 * @param catalogAttributeOptionEntityArray $_options the options

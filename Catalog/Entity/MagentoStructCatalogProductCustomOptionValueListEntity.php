<?php
/**
 * File for class MagentoStructCatalogProductCustomOptionValueListEntity
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructCatalogProductCustomOptionValueListEntity originally named catalogProductCustomOptionValueListEntity
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructCatalogProductCustomOptionValueListEntity extends MagentoWsdlClass
{
	/**
	 * The value_id
	...
	public $sort_order;
	/**
	 * Constructor method for catalogProductCustomOptionValueListEntity
	 ...
	 * @return MagentoStructCatalogProductCustomOptionValueListEntity
	 */
	public function __construct($_value_id = NULL,$_title = NULL,$_price = NULL,$_price_type = NULL,$_sku = NULL,$_sort_order = NULL)
	{
		parent::__construct(array('value_id'=>$_value_id,'title'=>$_title,'price'=>$_price,'price_type'=>$_price_type,'sku'=>$_sku,'sort_order'=>$_sort_order));
	}
	/**
	 * Get value_id value

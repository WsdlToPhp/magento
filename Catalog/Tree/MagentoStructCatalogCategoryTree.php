<?php
/**
 * File for class MagentoStructCatalogCategoryTree
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructCatalogCategoryTree originally named catalogCategoryTree
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructCatalogCategoryTree extends MagentoWsdlClass
{
	/**
	 * The category_id
	...
	public $children;
	/**
	 * Constructor method for catalogCategoryTree
	 ...
	 */
	public function __construct($_category_id = NULL,$_parent_id = NULL,$_name = NULL,$_position = NULL,$_level = NULL,$_children = NULL)
	{
		parent::__construct(array('category_id'=>$_category_id,'parent_id'=>$_parent_id,'name'=>$_name,'position'=>$_position,'level'=>$_level,'children'=>$_children));
	}
	/**

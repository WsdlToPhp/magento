<?php
/**
 * File for class MagentoStructCustomerCustomerEntityToCreate
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructCustomerCustomerEntityToCreate originally named customerCustomerEntityToCreate
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructCustomerCustomerEntityToCreate extends MagentoWsdlClass
{
	/**
	 * The customer_id
	...
	public $group_id;
	/**
	 * Constructor method for customerCustomerEntityToCreate
	 ...
	 * @return MagentoStructCustomerCustomerEntityToCreate
	 */
	public function __construct($_customer_id = NULL,$_email = NULL,$_firstname = NULL,$_lastname = NULL,$_password = NULL,$_website_id = NULL,$_store_id = NULL,$_group_id = NULL)
	{
		parent::__construct(array('customer_id'=>$_customer_id,'email'=>$_email,'firstname'=>$_firstname,'lastname'=>$_lastname,'password'=>$_password,'website_id'=>$_website_id,'store_id'=>$_store_id,'group_id'=>$_group_id));
	}
	/**

<?php
/**
 * File for class MagentoStructInteger
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructInteger originally named integer
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructInteger extends MagentoWsdlClass
{
	/**
	 * The _
	 * @var MagentoStructInteger
	 */
	public $_;
	/**
	 * The id
	 ...
	 * @param MagentoStructInteger $__
	 * @param MagentoStructID $_id
	 * @param MagentoStructAnyURI $_href
	 * @return MagentoStructInteger
	 */
	...
	/**
	 * Get _ value
	 * @return MagentoStructInteger|null
	 */
	...
	/**
	 * Set _ value
	 * @param MagentoStructInteger $__ the _
	 * @return MagentoStructInteger
	 */

<?php
/**
 * File for class MagentoStructID
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructID originally named ID
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructID extends MagentoWsdlClass
{
	/**
	 * The _
	 * @var MagentoStructID
	...
	/**
	 * Set _ value
	 * @param MagentoStructID $__ the _
	 * @return MagentoStructID
	 */

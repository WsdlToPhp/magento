<?php
/**
 * File for class MagentoStructShort
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructShort originally named short
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructShort extends MagentoWsdlClass
{
	/**
	 * The _
	 * @var MagentoStructShort
	 */
	public $_;
	/**
	 * The id
	...
	public $href;
	/**
	 * Constructor method for short
	 * @see parent::__construct()
	 * @param MagentoStructShort $__
	 * @param MagentoStructID $_id
	 * @param MagentoStructAnyURI $_href
	 * @return MagentoStructShort
	 */
	...
	/**
	 * Get _ value
	 * @return MagentoStructShort|null
	 */
	...
	/**
	 * Set _ value
	 * @param MagentoStructShort $__ the _
	 * @return MagentoStructShort
	 */

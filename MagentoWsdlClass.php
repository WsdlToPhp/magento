<?php
/**
 * File for MagentoWsdlClass to communicate with SOAP service
 * @package Magento
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
/**
 * MagentoWsdlClass to communicate with SOAP service
 * 
 * @package Magento
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses MagentoWsdlClass::setLastError()
	 * @uses MagentoWsdlClass::initSoapClient()
	 * @uses MagentoWsdlClass::initInternArrayToIterate()
	 * @uses MagentoWsdlClass::_set()
	...
	public static function __set_state(array $_array,$_className = __CLASS__)
	{
		if(class_exists($_className))
		{
			...
			if(is_object($object) && is_subclass_of($object,'MagentoWsdlClass'))
			{
	 ...
	 * @uses MagentoClassMap::classMap()
	 * @uses MagentoWsdlClass::getDefaultWsdlOptions()
	 * @uses MagentoWsdlClass::setSoapClient()
	 * @param array $_wsdlOptions WSDL options
	 * @return void
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('MagentoClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = MagentoClassMap::classMap();
	 ...
	 * @uses MagentoWsdlClass::WSDL_CACHE_WSDL
	 * @uses MagentoWsdlClass::WSDL_COMPRESSION
	 * @uses MagentoWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses MagentoWsdlClass::WSDL_ENCODING
	 * @uses MagentoWsdlClass::WSDL_EXCPTS
	 * @uses MagentoWsdlClass::WSDL_FEATURES
	 * @uses MagentoWsdlClass::WSDL_LOGIN
	 * @uses MagentoWsdlClass::WSDL_PASSWD
	 * @uses MagentoWsdlClass::WSDL_SOAP_VERSION
	 * @uses MagentoWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses MagentoWsdlClass::WSDL_TRACE
	 * @uses MagentoWsdlClass::WSDL_TYPEMAP
	 * @uses MagentoWsdlClass::WSDL_URL
	 * @uses MagentoWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses MagentoWsdlClass::getSoapClient()
	 * @uses MagentoWsdlClass::getFormatedXml()
	 ...
	 * @uses MagentoWsdlClass::getSoapClient()
	 * @uses MagentoWsdlClass::convertStringHeadersToArray()
	 ...
	 * @uses MagentoWsdlClass::getInternArrayToIterate()
	 * @uses MagentoWsdlClass::getInternArrayToIterateIsArray()
	 * @return int
	 */
	 ...
	 * @uses MagentoWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses MagentoWsdlClass::getInternArrayToIterateOffset()
	 * @uses MagentoWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses MagentoWsdlClass::getInternArrayToIterateOffset()
	 * @uses MagentoWsdlClass::offsetExists()
	 * @return bool true|false
	 */
	 ...
	 * @see MagentoWsdlClass::offsetGet()
	 * @uses MagentoWsdlClass::offsetGet()
	 * @param int $_index
	 * @return mixed
	 */
	 ...
	 * @uses MagentoWsdlClass::getAttributeName()
	 * @uses MagentoWsdlClass::__toString()
	 * @uses MagentoWsdlClass::_set()
	 * @uses MagentoWsdlClass::_get()
	 * @uses MagentoWsdlClass::setInternArrayToIterate()
	 * @uses MagentoWsdlClass::setInternArrayToIterateIsArray()
	 * @uses MagentoWsdlClass::setInternArrayToIterateOffset()

<?php
/**
 * File for class MagentoStructGYearMonth
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructGYearMonth originally named gYearMonth
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructGYearMonth extends MagentoWsdlClass
{
	/**
	 * The _
	 * @var MagentoStructGYearMonth
	 */
	public $_;
	/**
	 * The id
	...
	public $href;
	/**
	 * Constructor method for gYearMonth
	 * @see parent::__construct()
	 * @param MagentoStructGYearMonth $__
	 * @param MagentoStructID $_id
	 * @param MagentoStructAnyURI $_href
	 * @return MagentoStructGYearMonth
	 */
	...
	/**
	 * Get _ value
	 * @return MagentoStructGYearMonth|null
	 */
	...
	/**
	 * Set _ value
	 * @param MagentoStructGYearMonth $__ the _
	 * @return MagentoStructGYearMonth
	 */

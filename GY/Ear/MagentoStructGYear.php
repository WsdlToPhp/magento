<?php
/**
 * File for class MagentoStructGYear
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructGYear originally named gYear
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructGYear extends MagentoWsdlClass
{
	/**
	 * The _
	 * @var MagentoStructGYear
	 */
	public $_;
	/**
	 * The id
	...
	public $href;
	/**
	 * Constructor method for gYear
	 * @see parent::__construct()
	 * @param MagentoStructGYear $__
	 * @param MagentoStructID $_id
	 * @param MagentoStructAnyURI $_href
	 * @return MagentoStructGYear
	 */
	...
	/**
	 * Get _ value
	 * @return MagentoStructGYear|null
	 */
	...
	/**
	 * Set _ value
	 * @param MagentoStructGYear $__ the _
	 * @return MagentoStructGYear
	 */

<?php
/**
 * File for class MagentoStructDecimal
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructDecimal originally named decimal
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructDecimal extends MagentoWsdlClass
{
	/**
	 * The _
	 * @var MagentoStructDecimal
	 */
	public $_;
	/**
	 * The id
	...
	public $href;
	/**
	 * Constructor method for decimal
	 * @see parent::__construct()
	 * @param MagentoStructDecimal $__
	 * @param MagentoStructID $_id
	 * @param MagentoStructAnyURI $_href
	 * @return MagentoStructDecimal
	 */
	...
	/**
	 * Get _ value
	 * @return MagentoStructDecimal|null
	 */
	...
	/**
	 * Set _ value
	 * @param MagentoStructDecimal $__ the _
	 * @return MagentoStructDecimal
	 */

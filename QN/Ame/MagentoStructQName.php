<?php
/**
 * File for class MagentoStructQName
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructQName originally named QName
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructQName extends MagentoWsdlClass
{
	/**
	 * The _

<?php
/**
 * File for class MagentoStructNMTOKENS
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructNMTOKENS originally named NMTOKENS
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructNMTOKENS extends MagentoWsdlClass
{
	/**
	 * The _
	 * @var MagentoStructNMTOKENS
	 */
	public $_;
	/**
	 * The id
	...
	public $href;
	/**
	 * Constructor method for NMTOKENS
	 * @see parent::__construct()
	 * @param MagentoStructNMTOKENS $__
	 * @param MagentoStructID $_id
	 * @param MagentoStructAnyURI $_href
	 * @return MagentoStructNMTOKENS
	 */
	...
	/**
	 * Get _ value
	 * @return MagentoStructNMTOKENS|null
	 */
	...
	/**
	 * Set _ value
	 * @param MagentoStructNMTOKENS $__ the _
	 * @return MagentoStructNMTOKENS
	 */

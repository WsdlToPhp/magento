<?php
/**
 * File for class MagentoStructDateTime
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructDateTime originally named dateTime
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructDateTime extends MagentoWsdlClass
{
	/**
	 * The _
	 * @var MagentoStructDateTime
	 */
	public $_;
	/**
	 * The id
	...
	public $href;
	/**
	 * Constructor method for dateTime
	 * @see parent::__construct()
	 * @param MagentoStructDateTime $__
	 * @param MagentoStructID $_id
	 * @param MagentoStructAnyURI $_href
	 * @return MagentoStructDateTime
	 */
	...
	/**
	 * Get _ value
	 * @return MagentoStructDateTime|null
	 */
	...
	/**
	 * Set _ value
	 * @param MagentoStructDateTime $__ the _
	 * @return MagentoStructDateTime
	 */

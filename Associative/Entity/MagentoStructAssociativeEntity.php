<?php
/**
 * File for class MagentoStructAssociativeEntity
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructAssociativeEntity originally named associativeEntity
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructAssociativeEntity extends MagentoWsdlClass
{
	/**
	 * The key
	...
	public $value;
	/**
	 * Constructor method for associativeEntity

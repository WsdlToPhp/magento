<?php
/**
 * File for class MagentoStructNCName
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructNCName originally named NCName
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructNCName extends MagentoWsdlClass
{
	/**
	 * The _
	 * @var MagentoStructNCName
	 */
	public $_;
	/**
	 * The id
	...
	public $href;
	/**
	 * Constructor method for NCName
	 * @see parent::__construct()
	 * @param MagentoStructNCName $__
	 * @param MagentoStructID $_id
	 * @param MagentoStructAnyURI $_href
	 * @return MagentoStructNCName
	 */
	...
	/**
	 * Get _ value
	 * @return MagentoStructNCName|null
	 */
	...
	/**
	 * Set _ value
	 * @param MagentoStructNCName $__ the _
	 * @return MagentoStructNCName
	 */

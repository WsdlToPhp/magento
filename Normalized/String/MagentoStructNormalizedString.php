<?php
/**
 * File for class MagentoStructNormalizedString
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructNormalizedString originally named normalizedString
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructNormalizedString extends MagentoWsdlClass
{
	/**
	 * The _
	 * @var MagentoStructNormalizedString
	 */
	public $_;
	/**
	 * The id
	...
	public $href;
	/**
	 * Constructor method for normalizedString
	 * @see parent::__construct()
	 * @param MagentoStructNormalizedString $__
	 * @param MagentoStructID $_id
	 * @param MagentoStructAnyURI $_href
	 * @return MagentoStructNormalizedString
	 */
	...
	/**
	 * Get _ value
	 * @return MagentoStructNormalizedString|null
	 */
	...
	/**
	 * Set _ value
	 * @param MagentoStructNormalizedString $__ the _
	 * @return MagentoStructNormalizedString
	 */

<?php
/**
 * File for class MagentoStructGMonthDay
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructGMonthDay originally named gMonthDay
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructGMonthDay extends MagentoWsdlClass
{
	/**
	 * The _
	 * @var MagentoStructGMonthDay
	 */
	public $_;
	/**
	 * The id
	...
	public $href;
	/**
	 * Constructor method for gMonthDay
	 * @see parent::__construct()
	 * @param MagentoStructGMonthDay $__
	 * @param MagentoStructID $_id
	 * @param MagentoStructAnyURI $_href
	 * @return MagentoStructGMonthDay
	 */
	...
	/**
	 * Get _ value
	 * @return MagentoStructGMonthDay|null
	 */
	...
	/**
	 * Set _ value
	 * @param MagentoStructGMonthDay $__ the _
	 * @return MagentoStructGMonthDay
	 */

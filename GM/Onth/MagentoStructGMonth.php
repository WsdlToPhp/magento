<?php
/**
 * File for class MagentoStructGMonth
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructGMonth originally named gMonth
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructGMonth extends MagentoWsdlClass
{
	/**
	 * The _
	 * @var MagentoStructGMonth
	 */
	public $_;
	/**
	 * The id
	...
	public $href;
	/**
	 * Constructor method for gMonth
	 * @see parent::__construct()
	 * @param MagentoStructGMonth $__
	 * @param MagentoStructID $_id
	 * @param MagentoStructAnyURI $_href
	 * @return MagentoStructGMonth
	 */
	...
	/**
	 * Get _ value
	 * @return MagentoStructGMonth|null
	 */
	...
	/**
	 * Set _ value
	 * @param MagentoStructGMonth $__ the _
	 * @return MagentoStructGMonth
	 */

<?php
/**
 * File for class MagentoStructIDREFS
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructIDREFS originally named IDREFS
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructIDREFS extends MagentoWsdlClass
{
	/**
	 * The _
	 * @var MagentoStructIDREFS
	 */
	public $_;
	/**
	 * The id
	...
	public $href;
	/**
	 * Constructor method for IDREFS
	 * @see parent::__construct()
	 * @param MagentoStructIDREFS $__
	 * @param MagentoStructID $_id
	 * @param MagentoStructAnyURI $_href
	 * @return MagentoStructIDREFS
	 */
	...
	/**
	 * Get _ value
	 * @return MagentoStructIDREFS|null
	 */
	...
	/**
	 * Set _ value
	 * @param MagentoStructIDREFS $__ the _
	 * @return MagentoStructIDREFS
	 */

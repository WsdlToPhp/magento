<?php
/**
 * File for class MagentoStructPositiveInteger
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructPositiveInteger originally named positiveInteger
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructPositiveInteger extends MagentoWsdlClass
{
	/**
	 * The _
	 * @var MagentoStructPositiveInteger
	 */
	public $_;
	/**
	 * The id
	...
	public $href;
	/**
	 * Constructor method for positiveInteger
	 * @see parent::__construct()
	 * @param MagentoStructPositiveInteger $__
	 * @param MagentoStructID $_id
	 * @param MagentoStructAnyURI $_href
	 * @return MagentoStructPositiveInteger
	 */
	...
	/**
	 * Get _ value
	 * @return MagentoStructPositiveInteger|null
	 */
	...
	/**
	 * Set _ value
	 * @param MagentoStructPositiveInteger $__ the _
	 * @return MagentoStructPositiveInteger
	 */

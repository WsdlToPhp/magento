<?php
/**
 * File for class MagentoStructByte
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructByte originally named byte
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructByte extends MagentoWsdlClass
{
	/**
	 * The _
	 * @var MagentoStructByte
	 */
	public $_;
	/**
	 * The id
	...
	public $href;
	/**
	 * Constructor method for byte
	 * @see parent::__construct()
	 * @param MagentoStructByte $__
	 * @param MagentoStructID $_id
	 * @param MagentoStructAnyURI $_href
	 * @return MagentoStructByte
	 */
	...
	/**
	 * Set _ value
	 * @param MagentoStructByte $__ the _
	 * @return MagentoStructByte
	 */

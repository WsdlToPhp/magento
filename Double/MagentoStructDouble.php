<?php
/**
 * File for class MagentoStructDouble
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructDouble originally named double
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructDouble extends MagentoWsdlClass
{
	/**
	 * The _
	...
	public $href;
	/**
	 * Constructor method for double
	 * @see parent::__construct()
	 * @param MagentoStructDouble $__
	...
	/**
	 * Set _ value
	 * @param MagentoStructDouble $__ the _
	 * @return MagentoStructDouble
	 */

<?php
/**
 * File for class MagentoStructBoolean
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructBoolean originally named boolean
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructBoolean extends MagentoWsdlClass
{
	/**
	 * The _
	...
	public $href;
	/**
	 * Constructor method for boolean
	 * @see parent::__construct()
	 * @param MagentoStructBoolean $__
	...
	/**
	 * Set _ value
	 * @param MagentoStructBoolean $__ the _
	 * @return MagentoStructBoolean
	 */

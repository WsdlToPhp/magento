<?php
/**
 * File for class MagentoStructBase64Binary
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructBase64Binary originally named base64Binary
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructBase64Binary extends MagentoWsdlClass
{
	/**
	 * The _
	 * @var MagentoStructBase64Binary
	 */
	public $_;
	/**
	 * The id
	...
	public $href;
	/**
	 * Constructor method for base64Binary
	 * @see parent::__construct()
	 * @param MagentoStructBase64Binary $__
	 * @param MagentoStructID $_id
	 * @param MagentoStructAnyURI $_href
	 * @return MagentoStructBase64Binary
	 */
	...
	/**
	 * Get _ value
	 * @return MagentoStructBase64Binary|null
	 */
	...
	/**
	 * Set _ value
	 * @param MagentoStructBase64Binary $__ the _
	 * @return MagentoStructBase64Binary
	 */

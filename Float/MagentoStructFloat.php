<?php
/**
 * File for class MagentoStructFloat
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructFloat originally named float
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructFloat extends MagentoWsdlClass
{
	/**
	 * The _
	 * @var MagentoStructFloat
	 */
	public $_;
	/**
	 * The id
	...
	public $href;
	/**
	 * Constructor method for float
	 * @see parent::__construct()
	 * @param MagentoStructFloat $__
	 * @param MagentoStructID $_id
	 * @param MagentoStructAnyURI $_href
	 * @return MagentoStructFloat
	 */
	...
	/**
	 * Get _ value
	 * @return MagentoStructFloat|null
	 */
	...
	/**
	 * Set _ value
	 * @param MagentoStructFloat $__ the _
	 * @return MagentoStructFloat
	 */

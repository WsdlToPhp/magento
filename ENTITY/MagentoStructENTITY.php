<?php
/**
 * File for class MagentoStructENTITY
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructENTITY originally named ENTITY
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructENTITY extends MagentoWsdlClass
{
	/**
	 * The _
	 * @var MagentoStructENTITY
	 */
	public $_;
	/**
	 * The id
	...
	/**
	 * Get _ value
	 * @return MagentoStructENTITY|null
	 */
	...
	/**
	 * Set _ value
	 * @param MagentoStructENTITY $__ the _
	 * @return MagentoStructENTITY
	 */

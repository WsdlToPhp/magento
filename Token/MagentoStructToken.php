<?php
/**
 * File for class MagentoStructToken
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructToken originally named token
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructToken extends MagentoWsdlClass
{
	/**
	 * The _
	 * @var MagentoStructToken
	 */
	public $_;
	/**
	 * The id
	...
	/**
	 * Get _ value
	 * @return MagentoStructToken|null
	 */
	...
	/**
	 * Set _ value
	 * @param MagentoStructToken $__ the _
	 * @return MagentoStructToken
	 */

<?php
/**
 * File for class MagentoStructUnsignedInt
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructUnsignedInt originally named unsignedInt
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructUnsignedInt extends MagentoWsdlClass
{
	/**
	 * The _
	 * @var MagentoStructUnsignedInt
	 */
	public $_;
	/**
	 * The id
	...
	public $href;
	/**
	 * Constructor method for unsignedInt
	 * @see parent::__construct()
	 * @param MagentoStructUnsignedInt $__
	 * @param MagentoStructID $_id
	 * @param MagentoStructAnyURI $_href
	 * @return MagentoStructUnsignedInt
	 */
	...
	/**
	 * Get _ value
	 * @return MagentoStructUnsignedInt|null
	 */
	...
	/**
	 * Set _ value
	 * @param MagentoStructUnsignedInt $__ the _
	 * @return MagentoStructUnsignedInt
	 */

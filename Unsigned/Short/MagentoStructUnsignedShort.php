<?php
/**
 * File for class MagentoStructUnsignedShort
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructUnsignedShort originally named unsignedShort
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructUnsignedShort extends MagentoWsdlClass
{
	/**
	 * The _
	 * @var MagentoStructUnsignedShort
	 */
	public $_;
	/**
	 * The id
	...
	public $href;
	/**
	 * Constructor method for unsignedShort
	 * @see parent::__construct()
	 * @param MagentoStructUnsignedShort $__
	 * @param MagentoStructID $_id
	 * @param MagentoStructAnyURI $_href
	 * @return MagentoStructUnsignedShort
	 */
	...
	/**
	 * Get _ value
	 * @return MagentoStructUnsignedShort|null
	 */
	...
	/**
	 * Set _ value
	 * @param MagentoStructUnsignedShort $__ the _
	 * @return MagentoStructUnsignedShort
	 */

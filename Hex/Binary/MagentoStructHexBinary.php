<?php
/**
 * File for class MagentoStructHexBinary
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for MagentoStructHexBinary originally named hexBinary
 * @package Magento
 * @subpackage Structs
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class MagentoStructHexBinary extends MagentoWsdlClass
{
	/**
	 * The _
	 * @var MagentoStructHexBinary
	 */
	public $_;
	/**
	 * The id
	...
	public $href;
	/**
	 * Constructor method for hexBinary
	 * @see parent::__construct()
	 * @param MagentoStructHexBinary $__
	 * @param MagentoStructID $_id
	 * @param MagentoStructAnyURI $_href
	 * @return MagentoStructHexBinary
	 */
	...
	/**
	 * Get _ value
	 * @return MagentoStructHexBinary|null
	 */
	...
	/**
	 * Set _ value
	 * @param MagentoStructHexBinary $__ the _
	 * @return MagentoStructHexBinary
	 */
